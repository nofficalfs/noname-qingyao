window.config={
	...
	all:{
		...
		stockmode:['identity','guozhan','versus','boss','doudizhu','single','chess','connect','brawl'],
		stockextension:['boss','cardpile','coin','wuxing','xianjian','gujian','xuanyuanjian'],
